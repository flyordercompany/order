...
public class CartItemModel {
    ...
    public CartItemModel(int type, int productImage, String productTitle, String productPrice, String cuttedPrice, int freeCoupens, int productQuantity, int offersApplied, int coupensApplied) {
        this.type = type;
